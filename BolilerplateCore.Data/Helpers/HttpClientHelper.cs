using BoilerplateCore.Data.Extensions;
...
namespace BoilerplateCore.Data.Helpers
{
    public class HttpClientHelper
    {
        ...
        {
            WebApiUrl = AppServicesHelper.Configuration.GetSection("ARRMM:WebApiUrl").Value;
        ...
        //                return new LoginResponseModel { Status = Utilities.Enums.LoginStatus.Failed, Message = "Something went wrong. Please try again latter." };
